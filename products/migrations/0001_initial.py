        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.CharField(
                        help_text="format: required, letters, numbers, hyphens, max_length: 200",
                        max_length=200,
                        unique=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "keywords",
                    models.CharField(
                        help_text="format: required, These are used by Google to search for the product.These are words that are relevant to the product and will be added to the Product Name,and Category Name. Separate words with a comma:turtle, bespoke, etc, max_length: 150",
                        max_length=300,
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        verbose_name="Product Image - fallback jpeg image, the preferred image is                 created from this image",
                    ),
                ),
                (
                    "image_preferred",
                    models.ImageField(
                        default="images/default/default_image.png",
                        upload_to="images/products/",
                        verbose_name="WEBP Product Image - may not show on older devices,              so jpg is fallback image",
                    ),
                ),
                (
                    "image_alt_text",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default="Machine washable at 30° (hand-wash or delicate mode).             Gently squeeze out the remaining water using a towel,             do not wring out, stretch or twist to avoid misshape.             Dry flat, do not tumble dry.",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default="This item may include securely fastened safety eyes.             With regular use, these items may require de-pilling.",
                        help_text="Max_length: 1000",
                        null=True,
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        help_text="format: max_digits=5, decimal_places=2",
                        max_digits=5,
                        verbose_name="store retail price",
                    ),
                ),
                (
                    "sale_price",
                    models.DecimalField(
                        ...
                        decimal_places=2,
                        error_messages={
                            "name": "Please enter a valid price, max_digits=5, decimal_places=2"
                        },
                        help_text="format: max_digits=5, decimal_places=2",
                        max_digits=5,
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="format: true=available, false=sold-out",
                        verbose_name="product stock available",
                    ),
                ),
                (
                    "is_active",
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="enter date in format: Y-m-d H:M:S, null-true, blank-true",
                        verbose_name="product last updated",
                    ),
                ),
                (
                    "slug",
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        upload_to="images/reviews/",
                        verbose_name="WEBP Review Image - may not show on older devices,              so jpg is fallback image",
                    ),
                ),
